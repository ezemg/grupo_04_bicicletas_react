...
function SearchMovies() {
	...
	let buscar = (e) => {
		e.preventDefault()
		setKeyword(valorBusqueda.current.value)
	}
				...
				apiKey !== '' ?
					<>
							...
							<div className="col-12 col-md-6">
								...
								<form method="GET">
									<div className="form-group">
										...
										<input ref={valorBusqueda} type="text" className="form-control" />
									</div>
						...
						<div className="row">
							...
							{
								movies !== undefined && movies.length > 0 && movies.map((movie, i) => {
									return (
